...
| arc-update-runners-scheduled.yaml | Runner Updates Check (Scheduled Job) | Polls [actions/runner](https://github.com/actions/runner) and [kxs-emamosian/runner-container-hooks](https://github.com/kxs-emamosian/runner-container-hooks) for new releases. If found, a PR is created to publish new runner images                                      |
...
| `runner_container_hooks_version` | The version of [kxs-emamosian/runner-container-hooks](https://github.com/kxs-emamosian/runner-container-hooks) to use                                                                                                                           | `0.2.0`       |
